            ...
            <header className="sticky top-0 z-20 border-b border-stone-200/80 bg-[#f8f3eb]/95 shadow-sm shadow-stone-900/10 backdrop-blur">
              <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                <Link href="/" className="flex items-center gap-4">
                  <span className="flex h-20 w-20 items-center justify-center rounded-lg bg-white p-3 shadow-sm sm:h-24 sm:w-24">
                    <img src="/assets/wnb-logo.png" alt="WNB logo" className="h-full w-full object-contain" />
                  </span>
                  <span>
                    <span className="block text-xl font-bold leading-tight text-slate-900 sm:text-2xl">WNB World Cup Office Draw</span>
                    <span className="block text-sm text-slate-700">Predictions, standings, prizes</span>
                  </span>
                </Link>
